...
### 📰Descripcion📰
En este proyecto se busca automatizar todos los casos de prueba realizados para el proyecto final del curso "Tester QA Manual" de CoderHouse mediante Cypress.
